...
// CONCATENATED MODULE: ./lib/Regular.js
...
function () {
  ...
  _createClass(Regular, [{
    ...
    key: "clearSpace",
    value: function clearSpace(value) {
      try {
...
function () {
  ...
  _createClass(Dates, [{
    ...
    value: function timestampFormat(timestamp) {
      timestamp = timestamp.toString().length == 13 ? parseInt("".concat(timestamp / 1000)) : timestamp; //补零
...
// CONCATENATED MODULE: ./lib/Img.js
...
var fun = [Regular_Regular, lib_Utils, Dates_Dates, Img_Img]; //需要继承的方法
  ...
  try {
    for (var _iterator = Reflect.ownKeys(source)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (key !== "constructor" && key !== "prototype" && key !== "name") {
        ...
        var desc = Object.getOwnPropertyDescriptor(source, key); // target需要定义属性的当前对象  key当前需要定义的属性名  desc属性描述符
...
function (_mix) {
  ...
  function Yx() {
    ...
    return _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(Yx).apply(this, arguments));
  }

  return Yx;
}(mix.apply(void 0, fun));

Window.prototype.Yx = new lib_Yx();
